...
distance <- Waterdist(dplyr::select(map, OBJECTID), Stations_clust, OBJECTID, Latitude, Longitude, Clust)
distance_cov <-cov.from.dist(distance)
```
...
```{r}
loo_compare(mbase, mbase4, mbaseST, mbase4ST, mbaseST.2, mbase4ST.2, mbaseST2, mbase4ST2, mbase4ST3, mbase4ST4, m.1, m4.1.1, m.2, m.3, m4.3, m4.4, m4.5, m4.6)
```
