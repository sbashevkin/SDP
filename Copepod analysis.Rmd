...
m4.8<-brm(CPUE ~ poly(SalSurf_l_s, 2) + s(Temperature_s) + s(Date_num_s) + t2(Julian_day, Year, bs=c("cc", "cr")) + (1|Source) + (1|Clustered_station) + (1|Clustered_station2), family=hurdle_lognormal(),
       data=PF, cov_ranef = list(Clustered_station=distance_cov),
       prior=prior(normal(0,10), class="Intercept")+
         prior(normal(0,5), class="b")+
         prior(cauchy(0,5), class="sigma"),
...
```{r}
loo_compare(mbase, mbase4, mbaseST, mbase4ST, mbaseST.2, mbase4ST.2, mbaseST2, mbase4ST2, mbase4ST3, mbase4ST4, mbase4ST5, mbase4ST6, m.1, m4.1.1, m.2, m.3, m4.3, m4.4, m4.5, m4.6)
```
